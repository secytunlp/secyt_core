 ...
 */
class Campo extends \Secyt\Core\model\Campo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\Campo' . "\0" . 'codigo', '' . "\0" . 'Secyt\\Core\\model\\Campo' . "\0" . 'nombre'];
        }
