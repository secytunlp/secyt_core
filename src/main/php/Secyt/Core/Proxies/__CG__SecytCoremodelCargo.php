 ...
 */
class Cargo extends \Secyt\Core\model\Cargo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\Cargo' . "\0" . 'nombre', '' . "\0" . 'Secyt\\Core\\model\\Cargo' . "\0" . 'orden'];
        }
