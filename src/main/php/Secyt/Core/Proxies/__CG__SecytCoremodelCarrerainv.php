 ...
 */
class Carrerainv extends \Secyt\Core\model\Carrerainv implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\Carrerainv' . "\0" . 'nombre'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Carrerainv $proxy) {
