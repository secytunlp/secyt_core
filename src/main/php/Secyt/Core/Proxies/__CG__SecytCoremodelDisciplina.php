 ...
 */
class Disciplina extends \Secyt\Core\model\Disciplina implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\Disciplina' . "\0" . 'codigo', '' . "\0" . 'Secyt\\Core\\model\\Disciplina' . "\0" . 'nombre'];
        }
