 ...
 */
class Especialidad extends \Secyt\Core\model\Especialidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\Especialidad' . "\0" . 'codigo', '' . "\0" . 'Secyt\\Core\\model\\Especialidad' . "\0" . 'nombre', '' . "\0" . 'Secyt\\Core\\model\\Especialidad' . "\0" . 'disciplina'];
        }
