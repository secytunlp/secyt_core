 ...
 */
class EstadoIntegrante extends \Secyt\Core\model\EstadoIntegrante implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\EstadoIntegrante' . "\0" . 'nombre'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EstadoIntegrante $proxy) {
