 ...
 */
class Facultad extends \Secyt\Core\model\Facultad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\Facultad' . "\0" . 'codigo', '' . "\0" . 'Secyt\\Core\\model\\Facultad' . "\0" . 'nombre', '' . "\0" . 'Secyt\\Core\\model\\Facultad' . "\0" . 'cat'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Facultad $proxy) {
