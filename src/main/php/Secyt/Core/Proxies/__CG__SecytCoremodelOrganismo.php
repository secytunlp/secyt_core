 ...
 */
class Organismo extends \Secyt\Core\model\Organismo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\Organismo' . "\0" . 'codigo', '' . "\0" . 'Secyt\\Core\\model\\Organismo' . "\0" . 'nombre'];
        }
