 ...
 */
class TipoInvestigador extends \Secyt\Core\model\TipoInvestigador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\TipoInvestigador' . "\0" . 'nombre'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoInvestigador $proxy) {
