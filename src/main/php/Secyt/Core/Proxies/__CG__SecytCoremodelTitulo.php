 ...
 */
class Titulo extends \Secyt\Core\model\Titulo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\Titulo' . "\0" . 'nivel', '' . "\0" . 'Secyt\\Core\\model\\Titulo' . "\0" . 'nombre', '' . "\0" . 'Secyt\\Core\\model\\Titulo' . "\0" . 'universidad'];
        }
    ...
    public function getTituloUniversidad()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTituloUniversidad', []);

        return parent::getTituloUniversidad();
    }
