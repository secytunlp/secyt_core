 ...
 */
class Universidad extends \Secyt\Core\model\Universidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Secyt\\Core\\model\\Universidad' . "\0" . 'jurisdiccion', '' . "\0" . 'Secyt\\Core\\model\\Universidad' . "\0" . 'nombre', '' . "\0" . 'Secyt\\Core\\model\\Universidad' . "\0" . 'orden'];
        }
    ...
    public function setJurisdiccion($jurisdiccion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setJurisdiccion', [$jurisdiccion]);

        return parent::setJurisdiccion($jurisdiccion);
    }
