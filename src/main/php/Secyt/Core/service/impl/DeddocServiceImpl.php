...
use Secyt\Core\service\IDeddocService;
...
/**
 * servicio para Deddoc
 *  
 * @author Marcos
 * @since 13-06-2015
 *
 */
class DeddocServiceImpl extends CrudService implements IDeddocService {

	
	protected function getDAO(){
		return DAOFactory::getDeddocDAO();
	}
