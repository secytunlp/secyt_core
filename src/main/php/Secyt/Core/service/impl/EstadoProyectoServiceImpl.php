...
use Secyt\Core\service\IEstadoProyectoService;
...
/**
 * servicio para EstadoProyecto
 *  
 * @author Marcos
 * @since 11-04-2020
 *
 */
class EstadoProyectoServiceImpl extends CrudService implements IEstadoProyectoService {

	
	protected function getDAO(){
		return DAOFactory::getEstadoProyectoDAO();
	}
