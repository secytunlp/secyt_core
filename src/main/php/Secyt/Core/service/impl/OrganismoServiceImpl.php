...
use Secyt\Core\service\IOrganismoService;
...
/**
 * servicio para Organismo
 *  
 * @author Marcos
 * @since 13-06-2015
 *
 */
class OrganismoServiceImpl extends CrudService implements IOrganismoService {

	
	protected function getDAO(){
		return DAOFactory::getOrganismoDAO();
	}
