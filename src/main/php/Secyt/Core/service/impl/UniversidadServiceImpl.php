...
use Secyt\Core\service\IUniversidadService;
...
/**
 * servicio para Universidad
 *  
 * @author Marcos
 * @since 13-06-2015
 *
 */
class UniversidadServiceImpl extends CrudService implements IUniversidadService {

	
	protected function getDAO(){
		return DAOFactory::getUniversidadDAO();
	}
